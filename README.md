...
- **`GBA_369_Wards_Enriched.geojson`** — canonical ward boundaries plus ward-level coverage percentages and per-corporation attributes. Ward boundary display comes from this file; so do the Amenities grid's coverage-bar percentages (bus/metro/parks/toilets/lakes).
